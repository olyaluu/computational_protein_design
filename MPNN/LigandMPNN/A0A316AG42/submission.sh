...
#SBATCH --job-name=A0A316AG42_id40
...
--seed 120 \
--pdb_path "./inputs/mpj/A0A316AG42_id40" \
--out_folder "./outputs/mpj/A0A316AG42_id40" \
--omit_AA "CH" \
--bias_AA "A:-3.0" \
--redesigned_residues "A88 A91 A94 A95 A98 A97 A101 A102 A105 A108 A109 A77 A74 A70 A67 A63 A64 A33 A37 A40 A43 A44 A47 A50 A51 A54 A26 A22 A18 A19 A15 A11 A12 A8 A4 A5 A31 A25 A82 A83 A23 A78" \
--pack_side_chains 1 \
