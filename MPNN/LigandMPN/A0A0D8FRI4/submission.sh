...
#SBATCH --job-name=A0A0D8FRI4_id41
...
--seed 120 \
--pdb_path "./inputs/mpj/A0A0D8FRI4_id41" \
--out_folder "./outputs/mpj/A0A0D8FRI4_id41" \
--omit_AA "CH" \
--bias_AA "A:-3.0" \
--redesigned_residues "A2 A6 A9 A13 A16 A17 A20 A23 A24 A29 A35 A43 A44 A48 A51 A52 A54 A57 A58 A61 A64 A65 A73 A76 A77 A80 A83 A84 A87 A88 A91 A92 A94 A95 A105 A109 A111 A112 A115 A119 A122 A125 A126" \
--pack_side_chains 1 \
